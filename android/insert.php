...
$database_localhost ="android";//Nombre de nuestra base de datos
$username_localhost ="simbeer";//Nombre de usuario de nuestra base de datos (yo utilizo el valor por defecto)
$password_localhost ="s1mb33r";//Contraseña de nuestra base de datos (yo utilizo por defecto)
